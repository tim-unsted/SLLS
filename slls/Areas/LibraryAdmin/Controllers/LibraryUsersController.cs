...
{
    public class LibraryUsersController : AdminBaseController
    {
        ...
        public ActionResult Create()
        {
            ...
            var viewModel = new LibraryUserAddViewModel()
            {
                ...
                IgnoreAd = false,
                //PasswordMaxLength = int.Parse(Settings.GetParameterValue("Security.Passwords.MaximumLength", "999", "Specifies the maximum required length of a password.")),
                //PasswordMinLength = int.Parse(Settings.GetParameterValue("Security.Passwords.MinimumLength", "8", "Specifies the minimum required length of a password.")),
                //PasswordRequireDigit = Settings.GetParameterValue("Security.Passwords.RequireDigit", "false", "Specifies whether the password requires at least one digit (0-9).") == "true",
                //PasswordRequireLowercase = Settings.GetParameterValue("Security.Passwords.RequireLowercase", "false", "Specifies whether the password requires at least one lower-case letter.") == "true",
                //PasswordRequireUppercase = Settings.GetParameterValue("Security.Passwords.RequireUppercase", "false", "Specifies whether the password requires at least one upper-case letter") == "true",
                //PasswordRequireNonLetterOrDigit = Settings.GetParameterValue("Security.Passwords.RequireNonLetterOrDigit", "false", "Specifies whether the password requires at least one non-alphanumeric character (e.g. '$', '~', '?', etc.") == "true",
