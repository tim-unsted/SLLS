...
namespace slls.Utils
{
  ...
  internal partial class wwUtils
  {
    ...
    /// For example, you can access: this.oCustomer.oData.Supplier with (this,"oCustomer.oData.Supplier")
    ...
    /// <param name="Property">The property to retrieve. Example: 'Customer.Entity.Supplier'</param>
    /// <returns></returns>
    ...
    /// (ie. Customer.Entity.Supplier) as well as indexers.
    /// </summary>
    /// <param name="Parent">
    /// The Parent.
    /// </param>
